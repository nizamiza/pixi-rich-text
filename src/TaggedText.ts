...
export default class TaggedText<TextType extends PixiTextTypes = PIXI.Text> extends PIXI.Sprite {
    ...
    protected resetChildren() {
        if (this._textContainer) {
            ...
            this.removeChild(this._textContainer)?.destroy();
        }
        ...
        if (this._spriteContainer) {
            this._spriteContainer.removeChildren().forEach((child) => child.destroy());
            this.removeChild(this._spriteContainer)?.destroy();
        }
        ...
        if (this._decorationContainer) {
            ...
            this.removeChild(this._decorationContainer)?.destroy();
        }
        ...
        if (this._debugContainer) {
            ...
            this.removeChild(this._debugContainer)?.destroy();
        }
